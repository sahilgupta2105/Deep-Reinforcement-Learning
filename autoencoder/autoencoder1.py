...
def build_autoencoder():
	...
	conv1_2 = Conv2D(32, (3,3),activation=act,padding='same',kernel_initializer=init,kernel_regularizer = reg,use_bias=use_bias)(pool1)
	encoder = Dense(64,kernel_initializer=init,kernel_regularizer = reg,use_bias=use_bias)(conv1_2)
	decoder = Dense(64,kernel_initializer=init,kernel_regularizer = reg,use_bias=use_bias)(encoder)
	conv2_1 = Conv2D(32,(3,3),activation=act,padding='same',kernel_initializer=init,kernel_regularizer = reg,use_bias=use_bias)(decoder)
	up2 = UpSampling2D((2,2))(conv2_1)
